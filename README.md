...
This project is a simple web page created to practice basic HTML.  
It demonstrates fundamental HTML tags, page structure, and content layout.

---

## 📁 Project Contents

- Multiple & independent HTML files
